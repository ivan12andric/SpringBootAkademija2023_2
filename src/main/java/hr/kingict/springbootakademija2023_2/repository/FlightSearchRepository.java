...
public interface FlightSearchRepository extends JpaRepository<FlightSearchEntity, Long> {
    ...
    List<FlightSearchEntity> findByFlightSearch(String originLocationCode, String destinationLocationCode, LocalDate departureDate, LocalDate returnDate, Integer adults );


    FlightSearchEntity findByOriginLocationCodeAnd(String originLocationCode, String destinationLocationCode);
