...
public class FlightSearchDto {
    ...
    //outbound data
    private String outbundDepartureAirport;
    ...
    public String getOutbundDepartureAirport() {
        return outbundDepartureAirport;
    }

    public void setOutbundDepartureAirport(String outbundDepartureAirport) {
        this.outbundDepartureAirport = outbundDepartureAirport;
    }
